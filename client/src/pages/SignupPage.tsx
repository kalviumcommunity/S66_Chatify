    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0A0A0B] p-4">
      <div className="bg-[#16161A] rounded-xl shadow-md p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-[#FFFFFF] mb-2">Create an account</h2>
          <p className="text-[#5C5C5C] text-sm">Sign up to get started</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className={`w-full pl-10 pr-10 py-2 rounded-lg border ${
                  errors.confirmPassword ? 'border-red-500 focus:ring-red-200' : 'border-[#27272A] focus:ring-[#7C7DFF]'
                } bg-[#0A0A0B] text-[#FFFFFF] placeholder-[#6B7280] focus:outline-none focus:ring-4 focus:border-[#7C7DFF]`}
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-[#5C5C5C]">
            ...
            <Link to="/signin" className="font-medium text-[#7C7DFF] hover:text-[#9191FF]">
              Sign in
            </Link>
          </p>
        </div>
